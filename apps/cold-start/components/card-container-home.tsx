...
export const CardContainerHome = ({
  ...
  return (
    <div
      ...
      className={`transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-105 bg-gray-300 rounded flex flex-col items-center cursor-pointer sm:pb-0 sm:pt-8 pt-16 border-l-[10px] border-blue-50`}
    >
